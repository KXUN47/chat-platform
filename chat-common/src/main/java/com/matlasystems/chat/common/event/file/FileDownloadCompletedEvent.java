...
/**
 * Emitted when a file download completes.
 */
public final class FileDownloadCompletedEvent
    ...
    /**
     * Creates a new file download completed event.
     *
     * @param transferId transfer identifier
     * @param userId user identifier
     * @param fileId file identifier
     */
    public FileDownloadCompletedEvent(
            UUID transferId,
            Long userId,
            Long fileId) {
